...
public class Yunmu23Activity extends AppCompatActivity {
    private Yunmu23PronunciationExplainFragment mYunmu23PronunciationExplainFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYunmu23PronunciationExplainFragment = new Yunmu23PronunciationExplainFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.fragment_container,mYunmu23PronunciationExplainFragment).commit();
    }
}
