 ...
 */
public class Shengmu21PronunciationExplainFragment extends Fragment {

    public Shengmu21PronunciationExplainFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shengmu21_pronunciation, container, false);
    }
    ...
    private void setStartPracticeBtn(View startPracticeBtn){
        startPracticeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.fragment_container, new Shengmu21PracticeFragment()).commit();
            }
        });
    }
}
